...
if (isset($_POST['submit'])) {
  ...
  $req = $bdd->prepare("SELECT * FROM movies WHERE name = :title");
  ...
  echo"<html lang='en' dir='ltr'>";
    ...
    echo"<body style='background-color:#000000;color:white;'>";
        ...
        while($result = $req->fetch(PDO::FETCH_ASSOC)){
            ...
            $newcount = $current + 1;
            $req2 = $bdd->prepare("UPDATE movies SET viewers = :newcount WHERE name=:mname");
            $req2->bindValue('newcount',$newcount , PDO::PARAM_INT);
            $req2->bindValue('mname',$mname , PDO::PARAM_STR);
            $req2->execute();

            $req3 = $bdd->prepare("UPDATE user1 SET mid = :movieid WHERE id =:person ");
            $req3->bindValue('movieid',$movieid , PDO::PARAM_INT);
          ...
          echo"<br><h5 style='display: inline;color:#D8D8D8;'>".ucfirst($result['description'])."</h5>";
