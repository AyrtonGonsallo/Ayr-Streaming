   ...
   <header>
     <div class="container-fluid">
       ...
       <div class="container">
         ...
         <div class="jumbotron">
           <h1> Enter the tv serie details</h1>
           <p> <b></b> </p> <br>

           <form class="" action="backend/admin_control2.php" method="POST" enctype="multipart/form-data">

            <input type="text" class="form-control" placeholder="Serie Name" name="mname" value=""><br>
             ...
             <br>
             <input type="number" class="form-control" placeholder="Average Runtime in minutes of episodes" name="rtime" value="">
             <br>
             ...
             <br>
             <input type="text" class="form-control" placeholder="Number of seasons" name="seasons" value="">
             <br>
             <input type="text" class="form-control" placeholder="Number of episods" name="episods" value="">
             <br>
             <div class="row">
               <div class="col">
                 <table>
